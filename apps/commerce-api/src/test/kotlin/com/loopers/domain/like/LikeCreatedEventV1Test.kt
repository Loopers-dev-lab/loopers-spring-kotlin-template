...
class LikeCreatedEventV1Test {

    @DisplayName("LikeCreatedEventV1 생성 테스트")
    @Nested
    inner class Create {
        ...
        @DisplayName("eventType은 'LikeCreatedEventV1'이다")
        @Test
        fun `eventType is LikeCreatedEventV1`() {
            // given
            val userId = 1L
            val productId = 100L
            ...
            // then
            assertThat(event.eventType).isEqualTo("LikeCreatedEventV1")
        }
