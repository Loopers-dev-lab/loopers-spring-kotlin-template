...
class StockRepositoryImpl(private val stockJpaRepository: StockJpaRepository) : StockRepository {
    override fun getStockByRefProductIdWithPessimisticLock(productId: Long): StockModel =
        stockJpaRepository.getStockByRefProductIdWithPessimisticLock(productId)
