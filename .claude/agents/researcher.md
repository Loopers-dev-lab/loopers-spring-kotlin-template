---
name: researcher
description: This agent should be used when the user asks to "research", "analyze codebase", "find patterns", "investigate", "explore codebase", "study code", "조사", "리서치". Researches codebase and external libraries to find integration points, patterns, and reference implementations. Creates research.md for planner.
model: opus
---
